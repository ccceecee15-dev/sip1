...
const LOCATION_NAMES: Record<string, string[]> = {
  WAREHOUSE: [
    "DC EAST - NEWARK NJ", "DC WEST - LOS ANGELES CA", "DC CENTRAL - DALLAS TX",
    "DC SOUTH - ATLANTA GA", "DC NORTH - CHICAGO IL",
  ],
  STORE: [
    ...
    "TECH HUB-GLASGOW BUCHANAN", "LICK-HORSESHOE", "HARLEY-LINQ",
