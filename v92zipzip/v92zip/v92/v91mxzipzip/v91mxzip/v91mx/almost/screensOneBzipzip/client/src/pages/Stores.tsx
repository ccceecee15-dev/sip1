...
export default function Stores() {
  ...
  useEffect(() => {
    const loadData = async () => {
      const res = await mockService.getStoresData({});
      setData(res);
      setLoading(false);
    };
    loadData();
  ...
  const { kpis, storeTableData } = data;
  ...
  const currentTableData = filterDataByTab(storeTableData);

  if (isFocused) {
    return (
      <div className="h-screen w-screen bg-background overflow-hidden flex flex-col">
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h1 className="text-lg font-semibold">Store Performance</h1>
                      ...
                      <Table>
                        <TableHeader className="sticky top-0 bg-card z-10 shadow-sm">
                          <TableRow className="bg-muted/30 border-b-2 border-b-muted">
                            <TableHead className="sticky left-0 bg-background z-20 border-r w-[135px] font-bold text-black">Store</TableHead>
          ...
          <CardHeader className="pb-3 border-b bg-muted/5">
            <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Store-level sales and margin metrics</p>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2 bg-background p-1.5 rounded-md border">
                   ...
                   <Select value={selectedStoreFormat} onValueChange={setSelectedStoreFormat}>
                     <SelectTrigger className="h-7 w-[130px] border-0 bg-transparent focus:ring-0 text-xs">
                       <SelectValue placeholder="Store Format" />
                     </SelectTrigger>
                     <SelectContent>
                    ...
                    <TableRow className="bg-muted/30 border-b-2 border-b-muted">
                      ...
                      {showSalesColumns ? (
                        <>
                          ...
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">PTD vs LY %</TableHead>
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">PTD LFL %</TableHead>
                          ...
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">YoY LFL %</TableHead>
                          ...
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">YTD vs LY %</TableHead>
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">YTD LFL %</TableHead>
                          ...
                          <TableHead className="text-right bg-blue-50/50 font-bold text-blue-900 dark:bg-blue-950 dark:text-blue-300 border-r">PTD vs CP %</TableHead>
                      ...
                      <TableRow key={row.id} className="hover:bg-muted/30">
                        ...
                        {showSalesColumns ? (
                          <>
                            ...
                            <TableCell className="text-right border-r bg-blue-50/5 dark:bg-blue-950/20">{formatPercent(row.ytd_vs_cp_percent)}</TableCell>
                          </>
                        ) : (
